...
public struct UpdateWorkspace: JSONDecodable, JSONEncodable {
    ...
    */
    public init(name: String? = nil, description: String? = nil, language: String? = nil, intents: [CreateIntent]? = nil, entities: [CreateEntity]? = nil, dialogNodes: [DialogNode]? = nil, counterexamples: [CreateCounterexample]? = nil, metadata: [String: Any]? = nil) {
        self.name = name
